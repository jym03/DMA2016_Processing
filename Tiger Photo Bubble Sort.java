...
public class HelloWorldClass extends PApplet{

	public static void main(String[] args) {
		PApplet.main("HelloWorldPackage.HelloWorldClass");
	...
	public void setup(){
	  ...
	  for(int i = 0; i < img1.pixels.length-1; i++) {
		...
		//img1.pixels[i] = (0x00FFFFFF - (img1.pixels[i] | 0xFF000000)) | (img1.pixels[i] & 0xFF000000);  //only blue
